...
npx_df1_path <- "./1/sampleid_20230313-IO-YKKY0091_NPX.xlsx"
npx_df2_path <- "./2/sampleid_YKKY0091_IO_NPX.xlsx"
...
NPX_normalization <- olink_normalization(df1 = npx_df1, df2 = npx_df2, overlapping_samples_df1 = overlap_samples, df1_project_nr = "P1", df2_project_nr = "P2",
